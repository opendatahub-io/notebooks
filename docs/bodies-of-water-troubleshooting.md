...
| `sbom-syft-generate` fails with a StepOverride error on a legacy train | Known behavior of older konflux-central pipeline revisions | Escalate to DevOps with the PipelineRun name; do not patch `.tekton/` |
