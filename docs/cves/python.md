...
### Scenario: CVE-2025-66418 / CVE-2026-44431 in urllib3
...
1. Add to `dependencies/cve-constraints.txt` for general protection:
   ```
   # RHAIENG-2458: CVE-2025-66418, CVE-2026-44431 urllib3 decompression vulnerability
   urllib3>=2.7.0
   ```
...
2. Add override to jupyter images with odh-elyra (due to conflict):
   ```toml
   override-dependencies = [
       # RHAIENG-2458: CVE-2025-66418, CVE-2026-44431 urllib3 - override needed because odh-elyra pulls in
