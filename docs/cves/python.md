...
1. Add to `dependencies/cve-constraints.txt` for general protection:
   ...
   # RHOAIENG-64517: CVE-2026-44431 urllib3 information disclosure via cross-origin redirects
   urllib3>=2.7.0
   ```
...
2. Add override to jupyter images with odh-elyra (due to conflict):
   ```toml
   override-dependencies = [
       # RHAIENG-2458: CVE-2025-66418, RHOAIENG-64517: CVE-2026-44431 urllib3 - override needed because odh-elyra pulls in
