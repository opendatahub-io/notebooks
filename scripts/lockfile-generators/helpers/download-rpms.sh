...
run_createrepo_in_container() {
    ...
    echo "Creating repository metadata via $CONTAINER_ENGINE (notebook-rpm-lockfile image)..."
    $CONTAINER_ENGINE run --rm -v "${repo_dir_abs}:/repo:z" --platform=linux/x86_64 "$img" sh -c \
