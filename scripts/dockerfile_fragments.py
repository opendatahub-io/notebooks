...
def main():
    ...
    replacements = {
        ...
        """)),
        "Install micropipenv and uv to deploy packages from requirements.txt": '''RUN python -m pip install --no-cache-dir --extra-index-url https://pypi.org/simple -U "pip>=26.1.2" && python -m pip install --no-cache-dir --extra-index-url https://pypi.org/simple -U "micropipenv[toml]==1.9.0" "uv==0.9.6"''',
