...
// 0.3.14 + s390x pclntab fix (openshift/check-payload#337, RHAIENG-4982); pin until 0.3.15
require github.com/openshift/check-payload v0.0.0-20260520141154-d874e06d404c // indirect
