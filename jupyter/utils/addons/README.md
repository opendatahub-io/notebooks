...
PurgeCSS safelist in `webpack.config.mts`, re-run `pnpm build` and reload the browser tab.
...
- `webpack.config.mts`: Webpack configuration with enhanced tree-shaking
