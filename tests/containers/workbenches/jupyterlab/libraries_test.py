...
from tests.containers.conftest import get_image_metadata, Image
...
class TestWorkbenchImage:
    ...
    def test_image_entrypoint_starts(self, subtests: pytest_subtests.SubTests, jupyterlab_datascience_image: Image) -> None:
        ...
        try:
            try:
                ...
                ecode, stdout = container.exec([
                    "env", f"IMAGE={jupyterlab_datascience_image.labels["name"]}",
