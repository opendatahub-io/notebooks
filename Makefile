...
define pip_compile
	...
	$(CONTAINER_ENGINE) run -q --rm -i --pull=always --entrypoint="" $(PY_BUILDER_IMAGE) \
...
# Generate requirments.txt file, build and push jupyter-minimal-ubi8-python-3.8 image to the registry
.PHONY: jupyter-minimal-ubi8-python-3.8
jupyter-minimal-ubi8-python-3.8: base-ubi8-python-3.8
	$(call pip_compile,base/ubi8-python-3.8,\
		jupyter/minimal/ubi8-python-3.8/requirements.in,\
