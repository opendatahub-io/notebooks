...
#   ARG 3: Path of Dockerfile we want to build.
...
define build_image
	...
	$(ROOT_DIR)/scripts/sandbox.py --dockerfile '$(2)/$(3)' --build-context '$(2)' -- \
		$(CONTAINER_ENGINE) build $(CONTAINER_BUILD_CACHE_ARGS) --tag $(IMAGE_NAME) --file '$(2)/$(3)' $(BUILD_ARGS) {}\;
endef
...
define image
	...
	$(info #*# Image build directory: <$(RELEASE)/$(BUILD_DIRECTORY)> #(MACHINE-PARSED LINE)#*#...)
...
.PHONY: cuda-jupyter-datascience-ubi9-python-$(RELEASE_PYTHON_VERSION)
cuda-jupyter-datascience-ubi9-python-$(RELEASE_PYTHON_VERSION):
	$(call image,$@,jupyter/datascience/ubi9-python-$(RELEASE_PYTHON_VERSION)/Dockerfile.cuda,$<)
...
rocm-ubi9-python-3.11: base-ubi9-python-3.11
	$(call image,$@,rocm/ubi9-python-3.11/Dockerfile,$<)
...
rocm-jupyter-minimal-ubi9-python-3.11: rocm-ubi9-python-3.11
	$(call image,$@,jupyter/minimal/ubi9-python-3.11/Dockerfile,$<)
...
rocm-jupyter-datascience-ubi9-python-3.11: rocm-jupyter-minimal-ubi9-python-3.11
	$(call image,$@,jupyter/datascience/ubi9-python-3.11/Dockerfile,$<)
...
rocm-jupyter-tensorflow-ubi9-python-3.11: rocm-jupyter-datascience-ubi9-python-3.11
	$(call image,$@,jupyter/rocm/tensorflow/ubi9-python-3.11/Dockerfile,$<)
...
rocm-jupyter-pytorch-ubi9-python-3.11: rocm-jupyter-datascience-ubi9-python-3.11
	$(call image,$@,jupyter/rocm/pytorch/ubi9-python-3.11/Dockerfile,$<)
...
rocm-runtime-pytorch-ubi9-python-3.11: rocm-ubi9-python-3.11
	$(call image,$@,runtimes/rocm-pytorch/ubi9-python-3.11/Dockerfile,$<)
...
rocm-runtime-tensorflow-ubi9-python-3.11: rocm-ubi9-python-3.11
	$(call image,$@,runtimes/rocm-tensorflow/ubi9-python-3.11/Dockerfile,$<)
