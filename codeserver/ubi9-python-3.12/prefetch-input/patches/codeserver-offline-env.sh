...
# GHA-only: lib/vscode .npmrc build_from_source is patched by tweak-gha.sh; this covers
# custom-packages and other nested npm ci dirs that lack their own .npmrc.
