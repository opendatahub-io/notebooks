...
| CPU RStudio | - | 3.12 | RHEL9 | ✅ | ✅ | - | - | BuildConfig only (`manifests/…/rstudio-buildconfig.yaml`) — not prebuilt / not on quay |
...
| CUDA RStudio | 12.8 | 3.12 | RHEL9 | ✅ | ✅ | ❌ | ❌ | BuildConfig only (`manifests/…/cuda-rstudio-buildconfig.yaml`) — not prebuilt / not on quay |
